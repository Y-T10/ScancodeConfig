...
namespace CmpProc {
const std::expected<object_handle, DWORD> ExecElevated(
    bool isShow, const CompReg::win32str& execPath,
    const CompReg::win32str& param) noexcept {
...
const std::expected<DWORD, DWORD> WaitUntilExit(
